...
public class ProjectForm {
	...
	private Project	originalProject;	// Only for project editing circumstances
	...
	public Project build(List<User> users){
		return new Project(	this.code,		this.name,		this.description,
							this.leader,	this.isPublic,	users);
	}
	...
	public void update(){
		...
		this.originalProject.setIsPublic(isPublic);
