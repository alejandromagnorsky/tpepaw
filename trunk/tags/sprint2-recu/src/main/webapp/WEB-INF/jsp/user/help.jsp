				...
				<div class="helpSection">				
					<div id="addProjectHelp" class="helpTitle">Crear o editar proyecto</div>
						<p>
							...
							Para crear un proyecto diríjase a la página de inicio, seleccione el bóton de "Crear Proyecto"
							y complete los datos solicitados y presione "Aceptar". <br />
							Para editar un proyecto, selecciónelo en la página de inicio y elija el bóton de "Modificar proyecto". 
				...
				<div class="helpSection">
					<div id="projectStatusHelp" class="helpTitle">Ver estado de un proyecto</div>
						<p>
							...
							Para ver el estado de un proyecto, selecciónelo en la página de inicio y elija el bóton de "Ver estado".
						</p>
				</div>
				...
				<div class="helpSection">				
					<div id="addIssueHelp" class="helpTitle">Agregar o editar tarea</div>
						<p>
							...
							Para crear una tarea en cierto proyecto, selecciónelo en la página de inicio y elija el bóton de "Agregar tarea". 
							Luego complete los datos solicitados y presione "Aceptar".
						</p>
				</div>
				<div class="helpSection">
				...
				<div class="helpSection">				
					<div id="registerHelp" class="helpTitle">Registrar usuario</div>
						<p>
							...
							Para registrar un usuario, seleccione el bóton de "Registrar usuario" del encabezado, complete los datos solicitados y presione "Aceptar".
						</p>
				</div>
				<div class="helpSection">
					<div id="invalidateUserHelp" class="helpTitle">Invalidar usuario</div>
						<p>
							...
							Para invalidar un usuario, seleccione el bóton de "Invalidar usuario" del encabezado, complete los datos solicitados y presione "Aceptar".
						</p>
				</div>
			</div>
		</div>
