...
public class HibernateWebRequestCycle extends WebRequestCycle {
	...
	public HibernateWebRequestCycle(WebApplication application,
	...
	public static HibernateWebRequestCycle get() {
		...
		Assert.state(result instanceof HibernateWebRequestCycle,
				"Request cycle is not an instance of HibernateWebRequestCycle, but "
						+ result.getClass());
	...
	/**
	 * Start a new session. Will fail if a session is opened in the context of
	 * the current thread
	 */
	public void begin() {
	 ...
	 * <p>
	 * If you need to commit, but keep the session opened, use method
	 * <code>checkpoint</code> instead
	 * </p>
	 */
	public void commit() {
	 ...
	 * <p>
	 * If you need to rollback, but keep the session opened, use method
	 * <code>restart</code> instead
	 * </p>
	 */
