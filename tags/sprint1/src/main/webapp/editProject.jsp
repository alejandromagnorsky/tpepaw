				...
				<div id="form-style">
					<form action="editProject" method=POST>
						...
						<div class="form-left-column">
							...
							<input id="originalProjectName" type="hidden" name="originalProjectName" value="<c:out value="${originalProjectName}"/>"/>
							<input id="originalProjectCode" type="hidden" name="originalProjectCode" value="<c:out value="${originalProjectCode}"/>"/>
