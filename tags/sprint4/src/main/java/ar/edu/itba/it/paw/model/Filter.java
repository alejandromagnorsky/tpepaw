...
public class Filter extends AbstractModel implements Comparable<Filter>{
	...
	public Filter(String name, User user, Project project, String issueCode, String issueTitle,
		...
		// Don't use setProject here because
		// that method add the filter to the project too
		if (project == null)
	...
	public void setName(String name) {
		if(!ValidationUtils.validateMaxLength(name, 25))
			throw new IllegalArgumentException();
		this.name = name;
	}
	...
	public void setIssueCode(String issueCode) {
		if(!ValidationUtils.validateMaxLength(issueCode, 25))
			throw new IllegalArgumentException();
	...
	public void setIssueTitle(String issueTitle) {
		if(!ValidationUtils.validateMaxLength(issueTitle, 25))
			throw new IllegalArgumentException();
	...
	public void setIssueDescription(String issueDescription) {
		if(!ValidationUtils.validateMaxLength(issueDescription, 255))
			throw new IllegalArgumentException();
