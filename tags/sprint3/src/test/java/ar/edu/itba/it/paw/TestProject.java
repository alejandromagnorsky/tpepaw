...
public class TestProject {
	...
	public void initialize() {
		...
		reignInBlood = new Project("1986", "Reign In Blood", "Def Jam", jhanneman, true);
		seasonsInTheAbyss = new Project("1990", "Seasons In The Abyss", "Def Jam", kking, false);

		issue = new Issue(reignInBlood, "Angel Of Death", "1", new DateTime(), new Time(451), null, jhanneman, Issue.State.Open, Issue.Priority.Critical, Issue.Type.NewFeature);
	}
	...
	public void addVersionTest(){
		reignInBlood.addVersion(new Version());
		assertEquals(reignInBlood.getVersions().size() == 1, true);
		
		seasonsInTheAbyss.addVersion(new Version());
	...
	public void cannotAddFilterTest1(){
		seasonsInTheAbyss.addFilter(taraya, new Filter());
	}
	
	@Test(expected = IllegalArgumentException.class)	
	public void cannotAddFilterTest2(){
		reignInBlood.addFilter(null, new Filter());
	}
	...
	public void canViewVersionListTest(){
		...
		assertEquals(seasonsInTheAbyss.canViewVersionList(null), false);
	}
