...
public class TestUser {
	...
	public void initialize() {
		...
		taraya = new User(false, false, "taraya", "meaningofpain", "Tom Araya", "taraya@joinus.com");
		
		project = new Project("1986", "Reign In Blood", "Def Jam", jhanneman, false);
		issue = new Issue(project, "Angel Of Death", "1", new DateTime(), new Time(451), null, jhanneman, Issue.State.Open, Issue.Priority.Critical, Issue.Type.NewFeature);
	}
