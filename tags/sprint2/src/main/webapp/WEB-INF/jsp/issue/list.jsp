			...
			<div class="mainbar-title">
				...
				<div class="mainbar-controls">
					<div class="filter-menu-button-wrapper">
						<a href="../filter/add"><input class="filter-menu-button" type="submit" value="Aplicar nuevo filtro" /></a>
					</div>
					...
					<a class="commonControl" href="../issue/hottest"><div class="hottestButton" title="Ver tareas más visitadas"></div></a>
					<a class="commonControl" href="../issue/hottestOfMonth"><div class="hottestMonthButton" title="Ver tareas más visitadas del mes"></div></a>
					<a class="commonControl" href="../issue/hottestOfWeek"><div class="hottestWeekButton" title="Ver tareas más visitadas de la semana"></div></a>
				</div>				
			</div>
